...
if p2_score > p1_score:
    print ("Player 2 wins round one with a score of: " + str(int(p2_score)))
    win_score = p2_score
if p2_score == p1_score:
    print ("Round one tied, Press enter to begin tie breaker round")
    win_score = p1_score
else:
    print ("Player 1 wins round one with a score of: " + str(int(p1_score))) 
    win_score = p1_score
